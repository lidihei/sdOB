...
Here are the class used to build external likelihood, one can find the detail usage from the [web](https://docs.pymc.io/notebooks/blackbox_external_likelihood.html)
'''
