...
class LogLike(tt.Op):
    ...
    def perform(self, node, inputs, outputs):
        ...
        logl = self.likelihood(theta, self.wave_obs, self.flux_obs, self.fluxerr_obs, self.wavelength, self.flux1, self.flux2, self.arm, self.slmodel)
...
class LogLikeWithGrad(tt.Op):
    ...
    def __init__(self, loglike, wave_obs, flux_obs, fluxerr_obs, wavelength, flux1, flux2, arm='R', slmodel=None):
        ...
        self.arm = arm
        self.slmodel = slmodel
        self.logpgrad = LogLikeGrad(self.likelihood, self.wave_obs, self.flux_obs, self.fluxerr_obs, self.wavelength, self.flux1, self.flux2, self.arm, self.slmodel)
...
class LogLikeGrad(tt.Op):
    ...
    def perform(self, node, inputs, outputs):
        ...
        def lnlike(values):
            return self.likelihood(theta, self.wave_obs, self.flux_obs, self.fluxerr_obs, self.wavelength, self.flux1, self.flux2, self.arm, self.slmodel)
